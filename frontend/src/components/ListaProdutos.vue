<template>
    <div class="container mx-auto p-4">
      ...
      <div v-else-if="erro" class="text-center py-10 bg-red-100 border border-red-400 text-vermelho-radical px-4 py-3 rounded relative" role="alert">
      ...
      <div v-else-if="resultado?.produtos && resultado.produtos.length > 0" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div
        ...
        >
          <img :src="produto.imagemUrlPrincipal || 'https://via.placeholder.com/300x200?text=Radical'" alt="Imagem do produto" class="w-full h-48 object-cover">
          <div class="p-4 flex flex-col flex-grow">
            ...
            <button
             ...
             class="mt-auto w-full bg-vermelho-radical hover:bg-red-700 text-white font-bold py-2 px-4 rounded transition-colors duration-200"
            >
